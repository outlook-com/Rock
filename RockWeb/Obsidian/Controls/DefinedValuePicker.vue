...
<script>
    const controlAction = Obsidian.Util.getControlActionFunction({ controlType: 'DefinedValuePicker' });

    module.exports = {
        name: 'rock-definedvaluepicker',
        props: {
            value: {
                type: String,
                required: true
        ...
        watch: {
            ...
            definedTypeGuid: {
                ...
                handler: async function () {
                    ...
                    this.isLoading = true;
                    const result = await controlAction('GetValuesForType', {
                        definedTypeGuid: this.definedTypeGuid
                    });
